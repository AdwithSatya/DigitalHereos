...
*   **Live App (Vercel):** [Deploying to Vercel free tier]
*   **API Service (Render):** [Deploying to Render free tier]
...
4.  Configure the following **Environment Variable**:
    *   `VITE_API_URL`: Your live Render Web Service URL with the `/api` prefix (e.g., `https://divide-api.onrender.com/api`).
